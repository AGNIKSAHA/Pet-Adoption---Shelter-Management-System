...
interface TakeBackModalProps {
  ...
  onClose: () => void;
  onSubmit: (data: { returnStatus: string; notes: string }) => void;
  isPending: boolean;
  returnStatus: string;
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary-500 outline-none text-gray-700"
                value={returnStatus}
            ...
            <div>
              ...
              <textarea
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary-500 outline-none h-24 resize-none text-gray-700"
                placeholder="Describe pet's condition or reason for return..."
                value={returnNotes}
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              onClick={() => onSubmit({ returnStatus, notes: returnNotes })}
              disabled={isPending}
