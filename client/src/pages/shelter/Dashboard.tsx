...
import { Users, PawPrint, FileText, TrendingUp, Plus, ArrowRight, } from "lucide-react";
    ...
    return (<div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          {normalizedActiveShelterId ? (<p className="text-gray-500 mt-1">
              Overview of <strong>{currentShelterName}</strong> operations.
            </p>) : (<p className="text-gray-500 mt-1">Overview of your operations.</p>)}
        </div>
        <Link to="/shelter/pets" className="btn btn-primary flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-6">
            {recentActivity.map((activity: Activity) => (<div key={activity.id} className="flex items-start gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link to="/shelter/applications" className="p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors border border-gray-200 text-left group">
            ...
            <Link to="/shelter/pets" className="p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors border border-gray-200 text-left group">
              <div className="flex justify-between items-center mb-2">
            ...
            <Link to="/shelter/fosters" className="p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors border border-gray-200 text-left group">
              <div className="flex justify-between items-center mb-2">
