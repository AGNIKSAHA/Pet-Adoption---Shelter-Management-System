...
router.patch("/shelter-requests/:id/approve", adminController.approveShelterRequest);
router.patch("/shelter-requests/:id/reject", adminController.rejectShelterRequest);
