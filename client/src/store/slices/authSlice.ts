...
const authSlice = createSlice({
    ...
    reducers: {
        ...
        setActiveShelter: (state, action: PayloadAction<{
...
export const { setCredentials, setUser, setActiveShelter, logout, setLoading } = authSlice.actions;
