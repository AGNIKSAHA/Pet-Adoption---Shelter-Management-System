            ...
            >
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                  ...
                  <div className="flex flex-col items-end gap-3 w-full md:w-auto">
                    <div
                      className={`flex items-center gap-2 px-4 py-2 rounded-full border ${statusConfig.color} font-medium text-sm capitalize`}
                    >
                    ...
                    <Link
                      to={`/pets/${pet?._id}`}
                      className="flex items-center gap-1 text-primary-600 font-medium hover:text-primary-700 text-sm"
                    >
