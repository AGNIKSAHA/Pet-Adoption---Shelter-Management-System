...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 md:w-96 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-[60] animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="p-4 border-b border-gray-50 flex items-center justify-between bg-white/80 backdrop-blur-sm sticky top-0">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="text-[10px] bg-primary-50 text-primary-700 px-2 py-1 rounded-full font-bold hover:bg-primary-100 transition-colors"
            ...
            {isLoading ? (
              ...
              notifications?.map((notification: Notification) => (
                <div
                  ...
                  className={`p-4 transition-all group hover:bg-gray-50 ${
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start gap-2">
                        <p
                          className={`text-sm leading-tight mb-1 ${!notification.isRead ? "font-bold text-gray-900" : "text-gray-600"}`}
                        >
                          {notification.title}
                        </p>
                        <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          {!notification.isRead && (
                            <button
                              ...
                              className="p-1 hover:bg-white rounded text-primary-600 shadow-sm border border-gray-100"
                              title="Mark read"
                            >
                          ...
                          <button
                            ...
                            className="p-1 hover:bg-white rounded text-red-500 shadow-sm border border-gray-100"
                            title="Delete"
                          >
