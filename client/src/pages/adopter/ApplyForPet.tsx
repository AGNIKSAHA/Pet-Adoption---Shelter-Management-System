...
// Simplified schema for the application
...
export default function ApplyForPet() {
  ...
  const onSubmit = async (data: ApplicationForm) => {
    try {
      ...
      const applicationData = {
        ...
        references: [
          // Add placeholder references - you may want to add a references section to the form
          {
            name: "Reference 1",
            relationship: "Friend",
            phone: "000-000-0000",
  ...
  if (!petId) return <div>Pet not found</div>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full border-gray-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500"
                  placeholder="e.g. 1 Dog (Labrador, 5y), 2 Cats..."
                />
              </div>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border-gray-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500"
                  placeholder="Tell us about your past experience with pets..."
                />
                {errors.experience && (
                  <p className="text-red-500 text-xs mt-1">
