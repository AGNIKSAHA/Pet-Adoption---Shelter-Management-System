...
import {
  createPetValidation,
  createPetTransferValidation,
  requestVetSignoffValidation,
  respondPetTransferValidation,
  updatePetValidation,
...
router.post(
  ...
  validate(createPetTransferValidation),
  petController.createPetTransferRequest,
);
...
router.get(
  ...
  authenticate,
  authorize("shelter_staff"),
  petController.getMyPetTransferRequests,
);
...
router.patch(
  ...
  authenticate,
  authorize("shelter_staff"),
  validate(respondPetTransferValidation),
  petController.respondPetTransferRequest,
);
...
router.post(
  ...
  authenticate,
  authorize("shelter_staff", "admin"),
  checkShelterAccess("shelter_staff"),
...
router.post(
  "/:id/request-vet-signoff",
  authenticate,
  authorize("shelter_staff", "admin"),
  checkShelterAccess("shelter_staff"),
  validate(requestVetSignoffValidation),
  petController.requestVetMedicalRelease,
);

router.get(
  "/vet-approvals/:token/:decision",
  petController.processVetMedicalRelease,
);
