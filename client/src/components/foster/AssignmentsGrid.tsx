        ...
        assignments.map((assignment: FosterAssignment) => (
          ...
          >
            ...
            <div className="p-4 space-y-4">
              ...
              <button
                onClick={() => onTakeBack(assignment)}
                disabled={isTakeBackPending}
                className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-primary-50 text-primary-600 hover:bg-primary-100 rounded-xl font-semibold transition-all border border-primary-100"
              >
